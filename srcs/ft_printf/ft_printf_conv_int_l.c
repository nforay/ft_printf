...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   ft_printf_conv_int_l.c                             :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: nforay <nforay@student.42.fr>              +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2020/03/09 17:13:26 by nforay            #+#    #+#             */
/*   Updated: 2020/03/09 18:33:06 by nforay           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	print_conv_int_l_end(t_state_machine *m, int size)
{
	print_hash(m);
	ft_printf_nbr_l_fd(m->args.ld, size, m);
	while (m->fwidth > 0)
	{
		ft_putchar_fd(' ', 1);
		m->len++;
